...
| ----------- | ------------------ | -------------------------------------------------------------- |
| Cursor      | `~/.cursor` exists | `~/.cursor/skills/grounder-{note,search,overview,recall,handoff,plan}/SKILL.md` |
| Claude Code | `~/.claude` exists | `~/.claude/skills/grounder-{note,search,overview,recall,handoff,plan}/SKILL.md` |
