...
export async function runInitWithOptions(options: InitOptions = {}): Promise<number> {
  ...
  const notesDir = resolveNotesDir(home!, { version: 1, projectId: detected.id }, options.vault);
